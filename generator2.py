...
def generator(config):
    ...
    num_train= num_val= num_test = num_class
    ...
    num_images = [config.num_image_per_class, 
                            int(config.num_image_per_class*(config.train_val_test_ratio[1]/config.train_val_test_ratio[0])),
                            int(config.num_image_per_class*(config.train_val_test_ratio[2]/config.train_val_test_ratio[0]))]
...
def argparser():   
    ...
    parser.add_argument('--train_val_test_ratio', type=int, nargs='+',
                        default=[80, 10, 10], help='percentage')
